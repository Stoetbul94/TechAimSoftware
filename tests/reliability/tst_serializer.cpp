...
void run_serializer_tests()
{
    ...
    // every event type round-trips through serialize -> deserialize
    {
        QVector<DomainEvent> catalogue = {
            ...
            PositionTransitionSessionStarted{QStringLiteral("position_transition"),
                                             QStringLiteral("K,P,S"), 5, 1, 0,
                                             QStringLiteral("Natural point of aim")},
            PositionSetupStarted{0, 1},
            PositionChecklistUpdated{0, 1, 2, 1},
            PositionReady{0, 1, 42000},
            PositionSighterAccepted{ShotCore{0, 0, 0, 0, 40, 8, 95, 0, 5000, 0, 0, 9, true}, 0, 1},
            PositionVerificationStarted{0, 1, 42000},
            PositionVerificationShotAccepted{ShotCore{1, 1, 0, 0, 12, 34, 104, 0, 46000, 0, 0, 10, true}, 0, 1, 1},
