...
# quietly replaced.
# EVAL4 - EVAL3 plus one support-bundle correction: a SETA bundle now
# collects SETA data only. EVAL3's package is preserved as its own evidence.
